/**
 *Submitted for verification at mumbai.polygonscan.com on 2021-07-28
...
// File @animoca/ethereum-contracts-core-1.1.1/contracts/payment/PayoutWallet.sol@v1.1.1
...
contract SessionsManager is Recoverable, ERC20Receiver, PayoutWallet {
     ...
     */
    function onERC20Received(address /*sender*/, address from, uint256 value, bytes calldata data) external override returns (bytes4) {

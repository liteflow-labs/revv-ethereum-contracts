/**
 *Submitted for verification at mumbai.polygonscan.com on 2021-07-09
Compiler Version v0.7.6+commit.7338295f
Optimization Enabled: Yes with 2000 runs
Other Settings: default evmVersion, MIT license
 */

// Sources flattened with hardhat v2.4.1 https://hardhat.org

// File @animoca/ethereum-contracts-core-1.1.0/contracts/utils/types/AddressIsContract.sol@v1.1.0
...
// File @animoca/ethereum-contracts-core-1.1.0/contracts/utils/ERC20Wrapper.sol@v1.1.0
...
library ERC20Wrapper {
    ...
    function wrappedTransfer(IWrappedERC20 token, address to, uint256 value) internal {
        _callWithOptionalReturnData(token, abi.encodeWithSelector(token.transfer.selector, to, value));
    }

    function wrappedTransferFrom(IWrappedERC20 token, address from, address to, uint256 value) internal {
        _callWithOptionalReturnData(token, abi.encodeWithSelector(token.transferFrom.selector, from, to, value));
    }

    function wrappedApprove(IWrappedERC20 token, address spender, uint256 value) internal {
...
// File @animoca/ethereum-contracts-core-1.1.0/contracts/metatx/ManagedIdentity.sol@v1.1.0
...
// File @animoca/ethereum-contracts-core-1.1.0/contracts/access/IERC173.sol@v1.1.0
...
// File @animoca/ethereum-contracts-core-1.1.0/contracts/access/Ownable.sol@v1.1.0
...
// File @animoca/ethereum-contracts-core-1.1.0/contracts/utils/Recoverable.sol@v1.1.0
...
abstract contract Recoverable is ManagedIdentity, Ownable {
     ...
     */
    function recoverERC20s(address[] calldata accounts, address[] calldata tokens, uint256[] calldata amounts) external virtual {
        _requireOwnership(_msgSender());
     ...
     */
    function recoverERC721s(address[] calldata accounts, address[] calldata contracts, uint256[] calldata tokenIds) external virtual {
        _requireOwnership(_msgSender());
        uint256 length = accounts.length;
...
// File @animoca/ethereum-contracts-core-1.1.0/contracts/introspection/IERC165.sol@v1.1.0
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20.sol@v1.1.1
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20Detailed.sol@v1.1.1
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20Allowance.sol@v1.1.1
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20SafeTransfers.sol@v1.1.1
...
interface IERC20SafeTransfers {
     ...
     * @return true.
     */
    function safeTransfer(address to, uint256 amount, bytes calldata data) external returns (bool);
     ...
     * @return true.
     */
    function safeTransferFrom(address from, address to, uint256 amount, bytes calldata data) external returns (bool);
}

// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20BatchTransfers.sol@v1.1.1
...
interface IERC20BatchTransfers {
     ...
     * @return a boolean value indicating whether the operation succeeded.
     */
    function batchTransferFrom(address from, address[] calldata recipients, uint256[] calldata amounts) external returns (bool);
}

// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20Metadata.sol@v1.1.1
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20Permit.sol@v1.1.1
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/IERC20Receiver.sol@v1.1.1
...
interface IERC20Receiver {
     ...
     */
    function onERC20Received(address sender, address from, uint256 value, bytes calldata data) external returns (bytes4);
}

// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/ERC20.sol@v1.1.1
    ...
    IERC20Permit
{
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, string memory tokenURI_) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        _tokenURI = tokenURI_;
    ...
    function safeTransfer(address to, uint256 amount, bytes calldata data) external virtual override returns (bool) {
        address sender = _msgSender();
    ...
    function safeTransferFrom(address from, address to, uint256 amount, bytes calldata data) external virtual override returns (bool) {
        address sender = _msgSender();
    ...
    function _transferFrom(address sender, address from, address to, uint256 value) internal {
...
// File @animoca/ethereum-contracts-core-1.1.0/contracts/bridging/IChildToken.sol@v1.1.0
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/ERC20Receiver.sol@v1.1.1
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/bridging/ChildERC20Base.sol@v1.1.1
...
// File @animoca/ethereum-contracts-assets-1.1.1/contracts/token/ERC20/ChildERC20.sol@v1.1.1
...
abstract contract ChildERC20 is ERC20, ChildERC20Base {
     ...
     * @return bytes4 `bytes4(keccak256("onERC20Received(address,address,uint256,bytes)"))`
     */
    function onERC20Received(address /*operator*/, address from, uint256 amount, bytes calldata /*data*/) public virtual override returns (bytes4) {
...
contract PolygonREVV is Recoverable, UsingUniversalForwarding, ChildERC20 {
    ...
    function recoverERC20s(address[] calldata accounts, address[] calldata tokens, uint256[] calldata amounts) external virtual override {
        _requireOwnership(_msgSender());
        uint256 length = accounts.length;
        require(length == tokens.length && length == amounts.length, "Recov: inconsistent arrays");
        for (uint256 i = 0; i != length; ++i) {
